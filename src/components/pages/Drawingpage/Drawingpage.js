  ...
  return (
    <Pagecontainer>
      <div className="drawing-container">
                ...
                <h3><IoLocationSharp />&nbsp;Годеч</h3>
                <p>Ламята Ема изпитва различни чувства едновременно...
                </p>
                 <a href="/todo" class="edit-button">РЕДАКТИРАЙ</a>
                <a href="/todo" class="share-f">СПОДЕЛИ <ImFacebook /></a>
